...
const ImageDetailSkeleton = ({ isVertical = false }: { isVertical?: boolean }) => {
  return (
    <div className="relative animate-pulse min-h-screen bg-white">
      <div
        className={cn(
      ...
      >
        {/* Image skeleton */}
        <div className="flex-1 flex items-center justify-center relative bg-gray-50/50">
        ...
        <div className="flex-1 space-y-6 text-sm lg:pl-10 pt-10">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              {[...Array(5)].map((_, i) => (
                <div key={i} className="h-6 bg-gray-100 rounded w-16" />
              ))}
            </div>
          </div>
        </div>
